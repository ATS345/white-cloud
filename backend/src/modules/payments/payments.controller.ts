...
export class PaymentsController {
  ...
  async handleCallback(
    ...
    return this.paymentsService.handleCallback(transactionId, callbackData);
  }
  ...
  @ApiBearerAuth()
  @HttpCode(HttpStatus.OK)
  async simulatePaymentSuccess(@Request() req, @Param('id') id: string) {
    return this.paymentsService.simulatePaymentSuccess(req.user.id, parseInt(id));
  }
}